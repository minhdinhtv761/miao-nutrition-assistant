import { MainFoodCompositionSchema } from "./main_food_composition.model.js";

export const DetailedFoodCompositionSchema = new MainFoodCompositionSchema();

DetailedFoodCompositionSchema.add({
  water: {
    type: Number,
    default: null,
    min: 0,
